<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if (empty($errores)){
            ...
            $query = " INSERT INTO comidas (imagen, nombrepro, descripcionpro, precio) VALUES 
...
<form class="formulario" method="POST" action="/comidas.php" enctype="multipart/form-data">
<fieldset>
        <legend>Anote su comida</legend>
        <label for="nombre">Nombre:</label>
        <input type="text" id="nombre" name="nombre" placeholder="Nombre del platillo" value="<?php echo $nombre ?>">
        <br>
        <br>
    ...
    <input type="submit" value="Crear comida" class="boton">
</form>
 </body>
 </html>
